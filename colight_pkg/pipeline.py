...
import time
import traceback
from colight_pkg.generator import Generator
from colight_pkg.updater import Updater
from colight_pkg.config import DIC_AGENTS, DIC_ENVS
from colight_pkg.construct_sample import ConstructSample
from colight_pkg.model_pool import ModelPool
from colight_pkg import model_test
...
class Pipeline:
    ...
    def __init__(self, dic_exp_conf, dic_agent_conf, dic_traffic_env_conf, dic_path):
        ...
        ##jj commented as its hard coded and spoils project at times
    ...
    def downsample(self, path_to_log, i):
        ...
        if os.path.getsize(path_to_pkl) == 0:
            print("WARNING: empty pkl file:", path_to_pkl)
            return
        with open(path_to_pkl, "rb") as f_logging_data:
            try:
                try:
                    ...
                    print("Corrupted pkl:", path_to_pkl, e)
                    return    
                # logging_data = pickle.load(f_logging_data)
    ...
    def run(self, multi_process=False):
        ...
        multi_process = True ###to remove later JJ 
        # trainf
